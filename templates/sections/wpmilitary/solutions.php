		...
		<div class="row">
			<div class="col-md-12">
				<div class="section-title text-center">
					<h2 class="gradient-purple">Our <span class="deeppink">Solutions</span></h2>
					<h3>We fight against the problems to make tools that will solves your problem.</h3>
				</div>
				...
				<div class="row">
					...
					<div class="solution d-flex">
						<div class="col-md-7">
							<h2 class="gradient-purple">WP Radio Player</h2>
							<h3>Worldwide Radio Station Directory Player for WordPress.</h3>
							...
							<a href="/wp-radio" class="btn">Explore More <i class="fas fa fa-long-arrow-right"></i></a>
						</div>
					...
					<div class="solution d-flex">
						<div class="col-md-5">
							<img src="<?php echo get_theme_file_uri( 'assets/images/wpmilitary/wp-tv-player.svg' ); ?>" class="img-fluid" alt="WP TV Player">
						</div>

						<div class="col-md-7">
							<h2 class="gradient-purple">WP TV Player</h2>
							<h3>Worldwide Live TV Channels Player for WordPress.</h3>
							<p>WP Live TV is a Plugin for WordPress to create a Worldwide TV Station Channel Directory Website.
								You Can Add and Play Unlimited Live TV Video Stream Link Such as: Youtube, Dailymotion, Vimeo, Souncloud or Self Hosted Videos.</p>
