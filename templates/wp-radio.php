...
<?php get_template_part( 'templates/sections/wp-radio/testimonial' ); ?>

<?php get_template_part( 'templates/sections/wp-radio/pricing' ); ?>

<?php get_template_part( 'templates/sections/wp-radio/fact' ); ?>
